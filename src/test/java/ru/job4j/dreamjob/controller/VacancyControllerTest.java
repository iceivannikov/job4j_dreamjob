...
public class VacancyControllerTest {
    ...
    public void whenSomeExceptionThrownThenGetErrorPageWithMessage() {
        ...
        assertThat(view).isEqualTo("errors/vacancies/404");
    ...
    void whenCreateThrowsExceptionThenReturnErrorViewWithMessage() {
        ...
        assertThat(model.getAttribute("vacancy")).isNull();
        assertThat(model.getAttribute("cities")).isNull();
    }

    @Test
    void whenVacancyExistsThenReturnOneViewWithVacancyAndCities() {
        var vacancy = new Vacancy(1, "test1", "desc1", now(), true, 1, 2);
        var city1 = new City(1, "Москва");
        var city2 = new City(2, "Санкт-Петербург");
        var expectedCities = List.of(city1, city2);
        ...
        assertThat(vacancy).isSameAs(model.getAttribute("vacancy"));
        assertThat(expectedCities).isSameAs(model.getAttribute("cities"));
    }

    @Test
    void whenVacancyNotFoundThenReturnErrorViewAndNoCitiesLoaded() {
        int id = 10;
    ...
    @Test
    void whenVacancyUpdatedThenRedirectToVacancies() throws IOException {
        var vacancy = new Vacancy(1, "test1", "desc1", now(), true, 1, 2);
        var fileDto = new FileDto(testFile.getOriginalFilename(), testFile.getBytes());
        var vacancyArgumentCaptor = ArgumentCaptor.forClass(Vacancy.class);
        var fileDtoArgumentCaptor = ArgumentCaptor.forClass(FileDto.class);
        ...
        assertThat(actualVacancy).isSameAs(vacancy);
        assertThat(fileDto).usingRecursiveComparison().isEqualTo(actualFileDto);
    }

    @Test
    void whenVacancyNotUpdatedThenReturnErrorView() {
        var vacancy = new Vacancy(1, "test1", "desc1", now(), true, 1, 2);
    ...
    @Test
    void whenVacancyDeletedThenRedirectToVacancies() {
        int id = 10;
    ...
    @Test
    void whenVacancyNotDeletedThenReturnErrorView() {
        int id = 10;
